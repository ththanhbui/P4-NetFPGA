...
//    assign dma_q_size = 'd16;
     ...
     bram_output_queues_1 (
      ...
      .m_axis_0_tdata (m_axis_oq_0_tdata), 
      .m_axis_0_tkeep (m_axis_oq_0_tkeep), 
      .m_axis_0_tuser (m_axis_oq_0_tuser), 
      .m_axis_0_tvalid(m_axis_oq_0_tvalid), 
      .m_axis_0_tready(m_axis_oq_0_tready), 
      .m_axis_0_tlast (m_axis_oq_0_tlast), 
      .m_axis_1_tdata (m_axis_oq_1_tdata), 
      .m_axis_1_tkeep (m_axis_oq_1_tkeep), 
      .m_axis_1_tuser (m_axis_oq_1_tuser), 
      .m_axis_1_tvalid(m_axis_oq_1_tvalid), 
      .m_axis_1_tready(m_axis_oq_1_tready), 
      .m_axis_1_tlast (m_axis_oq_1_tlast), 
      .m_axis_2_tdata (m_axis_oq_2_tdata), 
      .m_axis_2_tkeep (m_axis_oq_2_tkeep), 
      .m_axis_2_tuser (m_axis_oq_2_tuser), 
      .m_axis_2_tvalid(m_axis_oq_2_tvalid), 
      .m_axis_2_tready(m_axis_oq_2_tready), 
      .m_axis_2_tlast (m_axis_oq_2_tlast), 
      .m_axis_3_tdata (m_axis_oq_3_tdata), 
      .m_axis_3_tkeep (m_axis_oq_3_tkeep), 
      .m_axis_3_tuser (m_axis_oq_3_tuser), 
      .m_axis_3_tvalid(m_axis_oq_3_tvalid), 
      .m_axis_3_tready(m_axis_oq_3_tready), 
      .m_axis_3_tlast (m_axis_oq_3_tlast), 
      .m_axis_4_tdata (m_axis_oq_4_tdata), 
      .m_axis_4_tkeep (m_axis_oq_4_tkeep), 
      .m_axis_4_tuser (m_axis_oq_4_tuser), 
      .m_axis_4_tvalid(m_axis_oq_4_tvalid), 
      .m_axis_4_tready(m_axis_oq_4_tready), 
      .m_axis_4_tlast (m_axis_oq_4_tlast), 
    ...
    // Cache queues
     ...
     sss_cache_queues_1 (
      ...
      .s_axis_tuser   (m_axis_opl_tuser), 
      .s_axis_tvalid  (m_axis_opl_tvalid), 
      .s_axis_tready  (), // leave it blank because only the output queue can send 
      .s_axis_tlast   (m_axis_opl_tlast), 
      .m_axis_0_tdata (m_axis_cq_0_tdata), 
      .m_axis_0_tkeep (m_axis_cq_0_tkeep), 
      .m_axis_0_tuser (m_axis_cq_0_tuser), 
      .m_axis_0_tvalid(m_axis_cq_0_tvalid), 
      .m_axis_0_tready(m_axis_cq_0_tready), 
      .m_axis_0_tlast (m_axis_cq_0_tlast), 
      .m_axis_1_tdata (m_axis_cq_1_tdata), 
      .m_axis_1_tkeep (m_axis_cq_1_tkeep), 
      .m_axis_1_tuser (m_axis_cq_1_tuser), 
      .m_axis_1_tvalid(m_axis_cq_1_tvalid), 
      .m_axis_1_tready(m_axis_cq_1_tready), 
      .m_axis_1_tlast (m_axis_cq_1_tlast), 
      .m_axis_2_tdata (m_axis_cq_2_tdata), 
      .m_axis_2_tkeep (m_axis_cq_2_tkeep), 
      .m_axis_2_tuser (m_axis_cq_2_tuser), 
      .m_axis_2_tvalid(m_axis_cq_2_tvalid), 
      .m_axis_2_tready(m_axis_cq_2_tready), 
      .m_axis_2_tlast (m_axis_cq_2_tlast), 
      .m_axis_3_tdata (m_axis_cq_3_tdata), 
      .m_axis_3_tkeep (m_axis_cq_3_tkeep), 
      .m_axis_3_tuser (m_axis_cq_3_tuser), 
      .m_axis_3_tvalid(m_axis_cq_3_tvalid), 
      .m_axis_3_tready(m_axis_cq_3_tready), 
      .m_axis_3_tlast (m_axis_cq_3_tlast), 
      .m_axis_4_tdata (m_axis_cq_4_tdata), 
      .m_axis_4_tkeep (m_axis_cq_4_tkeep), 
      .m_axis_4_tuser (m_axis_cq_4_tuser), 
      .m_axis_4_tvalid(m_axis_cq_4_tvalid), 
      .m_axis_4_tready(m_axis_cq_4_tready), 
      .m_axis_4_tlast (m_axis_cq_4_tlast), 
    ...
    // Output Arbiter
      ...
      .s_axis_0_tdata (m_axis_oq_0_tdata), 
      .s_axis_0_tkeep (m_axis_oq_0_tkeep), 
      .s_axis_0_tuser (m_axis_oq_0_tuser), 
      .s_axis_0_tvalid(m_axis_oq_0_tvalid), 
      .s_axis_0_tready(m_axis_oq_0_tready), 
      .s_axis_0_tlast (m_axis_oq_0_tlast), 
      .s_axis_1_tdata (m_axis_cq_0_tdata), 
      .s_axis_1_tkeep (m_axis_cq_0_tkeep), 
      .s_axis_1_tuser (m_axis_cq_0_tuser), 
      .s_axis_1_tvalid(m_axis_cq_0_tvalid), 
      .s_axis_1_tready(m_axis_cq_0_tready), 
      .s_axis_1_tlast (m_axis_cq_0_tlast), 
      .S_AXI_AWADDR(S0_AXI_AWADDR), 
      .S_AXI_AWVALID(S0_AXI_AWVALID),
      .S_AXI_WDATA(S0_AXI_WDATA),  
      .S_AXI_WSTRB(S0_AXI_WSTRB),  
    ...
    // Output Arbiter 1
      ...
      .s_axis_0_tdata (m_axis_oq_1_tdata), 
      .s_axis_0_tkeep (m_axis_oq_1_tkeep), 
      .s_axis_0_tuser (m_axis_oq_1_tuser), 
      .s_axis_0_tvalid(m_axis_oq_1_tvalid), 
      .s_axis_0_tready(m_axis_oq_1_tready), 
      .s_axis_0_tlast (m_axis_oq_1_tlast), 
      .s_axis_1_tdata (m_axis_cq_1_tdata), 
      .s_axis_1_tkeep (m_axis_cq_1_tkeep), 
      .s_axis_1_tuser (m_axis_cq_1_tuser), 
      .s_axis_1_tvalid(m_axis_cq_1_tvalid), 
      .s_axis_1_tready(m_axis_cq_1_tready), 
      .s_axis_1_tlast (m_axis_cq_1_tlast), 
      .S_AXI_AWADDR(S0_AXI_AWADDR), 
      .S_AXI_AWVALID(S0_AXI_AWVALID),
      .S_AXI_WDATA(S0_AXI_WDATA),  
      .S_AXI_WSTRB(S0_AXI_WSTRB),  
    ...
    // Output Arbiter 2
      ...
      .s_axis_0_tdata (m_axis_oq_2_tdata), 
      .s_axis_0_tkeep (m_axis_oq_2_tkeep), 
      .s_axis_0_tuser (m_axis_oq_2_tuser), 
      .s_axis_0_tvalid(m_axis_oq_2_tvalid), 
      .s_axis_0_tready(m_axis_oq_2_tready), 
      .s_axis_0_tlast (m_axis_oq_2_tlast), 
      .s_axis_1_tdata (m_axis_cq_2_tdata), 
      .s_axis_1_tkeep (m_axis_cq_2_tkeep), 
      .s_axis_1_tuser (m_axis_cq_2_tuser), 
      .s_axis_1_tvalid(m_axis_cq_2_tvalid), 
      .s_axis_1_tready(m_axis_cq_2_tready), 
      .s_axis_1_tlast (m_axis_cq_2_tlast), 
      .S_AXI_AWADDR(S0_AXI_AWADDR), 
      .S_AXI_AWVALID(S0_AXI_AWVALID),
      .S_AXI_WDATA(S0_AXI_WDATA),  
      .S_AXI_WSTRB(S0_AXI_WSTRB),  
    ...
    // Output Arbiter 3
      ...
      .s_axis_0_tdata (m_axis_oq_3_tdata), 
      .s_axis_0_tkeep (m_axis_oq_3_tkeep), 
      .s_axis_0_tuser (m_axis_oq_3_tuser), 
      .s_axis_0_tvalid(m_axis_oq_3_tvalid), 
      .s_axis_0_tready(m_axis_oq_3_tready), 
      .s_axis_0_tlast (m_axis_oq_3_tlast), 
      .s_axis_1_tdata (m_axis_cq_3_tdata), 
      .s_axis_1_tkeep (m_axis_cq_3_tkeep), 
      .s_axis_1_tuser (m_axis_cq_3_tuser), 
      .s_axis_1_tvalid(m_axis_cq_3_tvalid), 
      .s_axis_1_tready(m_axis_cq_3_tready), 
      .s_axis_1_tlast (m_axis_cq_3_tlast), 
      .S_AXI_AWADDR(S0_AXI_AWADDR), 
      .S_AXI_AWVALID(S0_AXI_AWVALID),
      .S_AXI_WDATA(S0_AXI_WDATA),  
      .S_AXI_WSTRB(S0_AXI_WSTRB),  

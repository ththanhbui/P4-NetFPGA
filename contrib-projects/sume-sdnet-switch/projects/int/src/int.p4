    ...
    apply {
        ...
        if (p.INT.isValid()) {
            if (p.INT.total_hop_cnt >= p.INT.max_hop_cnt) {
                ...
                // TODO: fill INT header fields
                // p.int_switch_id.switch_id
                // p.int_egress_port_id.egress_port_id
                // p.int_ingress_tstamp.ingress_tstamp
                // p.int_ingress_port_id.ingress_port_id
                // p.int_q_occupancy.q_occupancy

...
nf0_pkts = make_ip_pkts(IP1, IP3, MAC1, MAC3, PKT_LEN, NUM_PKTS)
nf1_pkts = make_ip_pkts(IP2, IP3, MAC2, MAC3, PKT_LEN, NUM_PKTS)

schedule_pkts(nf0_pkts, 'nf0', BASE_TIME, RATE)
schedule_pkts(nf1_pkts, 'nf1', BASE_TIME, RATE)

# Apply the packets
nftest_send_phy('nf0', nf0_pkts)
nftest_send_phy('nf1', nf1_pkts)

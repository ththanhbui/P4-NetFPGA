...
(
    ...
    input   [2*REG_WIDTH+INDEX_WIDTH+OP_WIDTH:0]    tuple_in_@EXTERN_NAME@_input_DATA,
...
*/
    ...
    wire                              statefulValid_in = tuple_in_@EXTERN_NAME@_input_DATA[2*REG_WIDTH+INDEX_WIDTH+8]; 
    wire                                    valid_in   = tuple_in_@EXTERN_NAME@_input_VALID;
    wire    [INDEX_WIDTH-1:0]               index_in   = tuple_in_@EXTERN_NAME@_input_DATA[2*REG_WIDTH+INDEX_WIDTH+7 : 2*REG_WIDTH+8];
    wire    [REG_WIDTH-1:0]        newVal_in  = tuple_in_@EXTERN_NAME@_input_DATA[2*REG_WIDTH+7 : REG_WIDTH+8];
    wire    [REG_WIDTH-1:0]        incVal_in  = tuple_in_@EXTERN_NAME@_input_DATA[REG_WIDTH+7 : 8];

...
set design input_arbiter_drr 
set top input_arbiter_drr
...
puts "Creating Input Arbiter DRR IP"
# Project Constraints
#####################################
# Project Structure & IP Build
#####################################

read_verilog "./hdl/input_arbiter_drr_cpu_regs_defines.v"
read_verilog "./hdl/input_arbiter_drr_cpu_regs.v"
read_verilog "./hdl/input_arbiter_drr.v"

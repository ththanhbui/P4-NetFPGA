...
set design output_arbiter 
set top output_arbiter
...
puts "Creating Output Arbiter IP"
# Project Constraints
#####################################
# Project Structure & IP Build
#####################################

read_verilog "./hdl/output_arbiter_cpu_regs_defines.v"
read_verilog "./hdl/output_arbiter_cpu_regs.v"
read_verilog "./hdl/output_arbiter.v"
